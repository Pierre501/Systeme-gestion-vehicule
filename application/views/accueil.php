            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <p style="color: red;"><?php if(isset($erreur)) { echo $erreur; } ?></p>
                        <form action="<?php echo base_url(); ?>CtrlAdministrateur/insertionVehicule" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type">
                                    ...
                                    <?php foreach($tabViewVehicule as $viewVehicule) { ?>
                                        <option value="<?php echo $viewVehicule->getIdType(); ?>"><?php echo $viewVehicule->getType(); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
