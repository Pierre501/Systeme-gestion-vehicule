        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Ajouter un élément</h1>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    <p style="color: red;"><?php if(isset($erreur)) { echo "Oups! Veiullez réessayez s'il vous plait!"; } ?></p>
                            <form action="<?php echo base_url(); ?>CtrlAdministrateur/insertionElements" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="elements" class="form-control">
                                    <option>Choisir le type d'élément</option>
                                    <?php foreach($tabElement as $element) { ?>
                                        <option value="<?php echo $element->getIdElement(); ?>"><?php echo $element->getElement(); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
